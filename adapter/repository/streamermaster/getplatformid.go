...
type GetPlatformIdRepository struct {
	sqlHandler abstruct.SqlHandler
	query      string
}

func NewGetPlatformIdRepository(sqlHandler abstruct.SqlHandler, query string) streamermaster.GetPlatformIdRepository {
...
func (repos GetPlatformIdRepository) GetPlatformIdToStreamerId(platform string) (map[string]string, utility.IError) {
